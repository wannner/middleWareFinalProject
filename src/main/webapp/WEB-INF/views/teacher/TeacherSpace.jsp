            ...
            <li class="nav-item">
                ...
                <div class="sub-menu collapse" id="submenu1">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="showPage('http://localhost:8080/teacher/showAllCourse')">查看任课课程</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="showPage('http://localhost:8080/teacher/showAllCourse_Grade')">录入学生成绩</a>
                        </li>
                    </ul>
                </div>
            </li>
