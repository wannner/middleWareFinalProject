...
<div class="container">
  ...
  <div class="table-container">
    <table class="table custom-table">
      ...
      %>
      <form action="http://localhost:8080/teacher/updateStudentGrade">
      <tr>
        ...
        <td style="text-align: center"><input type="submit" value="录入成绩" class="delete-button"></td>
      </tr>
      </form>
      <%
          }
...
<script>
  function handleCourseSelection(term) {
    window.location.href = "http://localhost:8080/teacher/showAllCourse_Grade?term=" + term;
  }
</script>
