...
<div class="card">
    <h1>新增班级信息</h1>
    <form id="class-form" action="http://localhost:8080/manager/addClassCheck" onsubmit="return false;">
        <div class="form-row">
            <input type="" name="stud" id="stud">
...
<script>
    ...
    function submitForm() {
        ...
        $.ajax({
            url: 'http://localhost:8080/manager/addClassCheck',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(classArray),
            success: function (response) {
                alert('班级创建成功');
                window.location.href = 'http://localhost:8080/manager/addClass';//创建成功，放回创建页面
            },
